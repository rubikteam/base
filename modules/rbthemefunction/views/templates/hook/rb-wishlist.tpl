...
<div class="rb-wishlist">
	{if isset($wishlists) && count($wishlists) > 1}
		<div class="dropdown rb-wishlist-dropdown">
			<button class="rb-wishlist-button rb-btn-product dropdown-toggle show-list btn-product btn{if $added_wishlist} rb_added{/if}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-id-wishlist="{$id_wishlist}" data-id-product="{$rb_wishlist_id_product}" data-id-product-attribute="{$rb_wishlist_id_product_attribute}">
	...
	{else}
		<a class="rb-wishlist-link rb-btn-product {if $added_wishlist} rb_added{/if}" href="#" data-id-wishlist="{$id_wishlist}" data-id-product="{$rb_wishlist_id_product}" data-id-product-attribute="{$rb_wishlist_id_product_attribute}" title="{if $added_wishlist}{l s='Remove from Wishlist' d='Shop.Theme.Global'}{else}{l s='Add to Wishlist' d='Shop.Theme.Global'}{/if}">
			<i class="icon-btn-product icon-wishlist material-icons">&#xE87D;</i>
			<span class="icon-title">{l s='Add to Wishlist' d='Shop.Theme.Global'}</span>
		</a>
	{/if}
